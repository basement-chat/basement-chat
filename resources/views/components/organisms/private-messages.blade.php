                ...
                >
                    ...
                    >
                        <div class="bm-flex bm-flex-col bm-gap-y-1 bm-px-2">
                            <p class="bm-font-semibold">
                                <x-basement::atoms.icons.fas-check-double
                                    class="bm-inline bm-w-[0.9rem] bm-text-blue-500"
                                /> Read
                            </p>
                            <p
                        ...
                        <div class="bm-flex bm-flex-col bm-gap-y-1 bm-px-2">
                            <p class="bm-font-semibold">
                                <x-basement::atoms.icons.fas-check-double
                                    class="bm-inline bm-w-[0.9rem] bm-text-gray-500"
                                /> Delivered
                            </p>
                            <p
                                class="bm-text-gray-700"
                    ...
                    <div x-show="isMessageBoxOpened"">
                        ...
                        >
                            ...
                            <x-slot:title>Search Messages</x-slot>
                                <x-slot:icon>
                                    <x-basement::atoms.icons.fas-search
                                        class="bm-ml-2 bm-h-[0.9rem] bm-text-gray-400" />
                                    </x-slot>
                                            ...
                                            >
                                                ...
                                                <template x-if="message.receiverId === receiver.id">
                                                    <div class="bm-w-[10%]">
                                                        ...
                                                        >
                                                            <x-basement::atoms.icons.fas-ellipsis-v
                                                                class="bm-inline bm-h-3"
                                                            />
                                                        </x-basement::atoms.buttons.secondary>
